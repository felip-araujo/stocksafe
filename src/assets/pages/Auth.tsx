...
export function LoginPage() {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen">
      ...
      <div className="hidden md:flex w-1/2 bg-zinc-950 items-center justify-center">
        <LogoNomeBranco />
      </div>

      {/* Lado Direito – Formulário */}
      <div className="flex w-full md:w-1/2 items-center justify-center bg-gray-100 p-6 min-h-screen md:min-h-full">
