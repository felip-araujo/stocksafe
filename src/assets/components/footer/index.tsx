...
export function Footer() {
  return (
    <footer className="bg-zinc-900 text-zinc-100 py-6 px-4 mt-10 border-t border-zinc-200">
      <div className="max-w-6xl mx-auto flex flex-col items-center text-center sm:flex-row sm:justify-between sm:text-left">
        ...
        {/* Direitos autorais */}
        <div className="text-xs text-zinc-100 mt-2 sm:mt-0">
          © {new Date().getFullYear()} StockSeguro — Todos os direitos reservados.
        </div>
      </div>
    </footer>
  );
